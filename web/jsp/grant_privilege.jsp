			...
			<table border="1" style="text-align: center;">
				...
				<tr>
					...
					<td>已具有权限： <c:forEach items="${privilegeList}"
										  var="privileges">
						${privileges.name}<input type="checkbox" name="privilegedelete" value="${privileges.id}" checked="checked">&nbsp;
					</c:forEach>
					</td>
				</tr>
				...
				<tr>
					<td>系统所有权限列表</td>
					<td> <c:forEach items="${privilegeList}" var="privileges">
